...
|**aggregation**(집계)|기본적으로 측정값이 각 차원에 따라 합계되지만 그러나 `AggregateFunction` 속성을 사용하여 이 동작을 수정할 수 있습니다. 목록은 [Use Aggregate Functions](use-aggregate-functions.md) 을 참조하세요.|
