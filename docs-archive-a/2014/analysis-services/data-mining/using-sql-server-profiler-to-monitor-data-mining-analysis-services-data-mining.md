...
|----------------|-------------------|-----------------|  
|**쿼리 시작**<br /><br /> **쿼리 종료**|**0 - MDXQuery**|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 저장 프로시저에 대한 모든 호출의 텍스트를 포함합니다.|  
...
|**검색 시작**<br /><br /> **검색 끝**|여러|XMLA로 캡슐화된 DMX 함수 호출 또는 DISCOVER 문의 텍스트를 포함합니다.|  
