...
# <a name="creating-an-analysis-services-project"></a>Analysis Services 프로젝트 만들기
  다음 작업에서는를 사용 하 여 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] `Analysis Services Tutorial` 프로젝트 템플릿을 기반으로 이라는 새 프로젝트를 만듭니다 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] . *프로젝트* 는 관련된 개체의 모음입니다. 프로젝트는 솔루션 내에 있으며 솔루션은 하나 이상의 프로젝트를 포함합니다. 자세한 내용은 [Analysis Services 프로젝트 만들기&#40;SSDT&#41;](multidimensional-models/create-an-analysis-services-project-ssdt.md)를 참조하세요.  
...
4.  프로젝트 이름을로 변경 하 여 `Analysis Services Tutorial` **솔루션 이름** 상자도 변경한 다음 **확인**을 클릭 합니다.  
  
 `Analysis Services Tutorial`이라는 새 솔루션 내에서 **Analysis Services 다차원 및 데이터 마이닝 프로젝트** 템플릿을 기반으로 프로젝트를 성공적으로 만들었습니다 `Analysis Services Tutorial` .  
