...
|@(at 기호)|[at]|*사용자 이름* @hotmail.com *사용자 이름이*됩니다. [at] hotmail .com|
|& (앰퍼샌드)|[amp]|*사용자 이름* @ *회사* & *company.com* 은 *username*[at]*company*[amp]*company.com* 이 됩니다.|
|$(달러 기호)|[dollar]|*사용자*  $ *Name* 은 *User*[] [won]*name* 이 됩니다.|
