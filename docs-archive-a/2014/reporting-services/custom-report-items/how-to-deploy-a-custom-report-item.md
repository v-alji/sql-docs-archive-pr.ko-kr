...
1.  Rsreportdesigner.config 파일을 편집하여 디자이너에서 사용하도록 사용자 지정 보고서 항목 런타임 및 디자인 타임 구성 요소를 구성합니다. `ReportItemName` 항목이 `CustomReportItemAttribute` 클래스에 사용되는 `CustomReportItemDesigner` 특성과 일치해야 합니다. 예:  
