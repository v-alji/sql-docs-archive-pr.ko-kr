...
# <a name="what39s-new-in-report-builder-for-sql-server-2014"></a>SQL Server 2014에 대 한 보고서 작성기의 새로운 기능&#39;
 ...
 다른 제품 및 기술에 대 한이 릴리스의 기능에 대 한 자세한 내용은 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] [SQL Server 2014의 새로운](../sql-server/what-s-new-in-sql-server-2016.md)기능을 참조 하세요.  
