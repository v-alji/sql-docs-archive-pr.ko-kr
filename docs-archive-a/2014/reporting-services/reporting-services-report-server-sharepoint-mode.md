...
##  <a name="components-that-provide-integration"></a><a name="bkmk_components"></a>통합을 제공 하는 구성 요소
 ...
 서버를 단일 배포로 결합 하려면 설치를 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] SharePoint 제품의 인스턴스와 통합 해야 합니다.  
