...
|----------|-----------------|-------------------|  
|[!INCLUDE[ssCrescent](../../includes/sscrescent-md.md)]|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 테이블 형식 모델을 기반으로 보고서를 만들고 보고서와 상호 작용할 수 있도록 디자인한 대화형 데이터 탐색 및 시각 표현 환경입니다.<br /><br /> 참고: [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 모드에는가 필요 합니다.|Silverlight 브라우저를 사용합니다.|  
...
## <a name="tools-for-report-server-administration"></a>보고서 서버 관리를 위한 도구  
 에서 보고서 서버를 관리 하는 데 사용할 수 있는 그래픽 및 스크립팅 도구 집합 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 입니다. 사용하는 도구는 사용하는 보고서 서버의 배포 모드에 따라 다릅니다.  
...
|SQL Server 구성 관리자|이 도구를 사용하면 다음을 수행할 수 있습니다.<br /><br /> Reporting Services Windows 서비스 시작 및 중지<br /><br /> 고객 의견 보고, 덤프 디렉터리 위치 및 오류 보고 구성<br /><br /> <br /><br /> 경고 서비스 계정을 구성 하는 데이 도구를 사용 하지 않습니다. ** \* \* \* \* ** 대신 Reporting Services 구성 도구를 사용합니다.<br /><br /> 자세한 내용은 [SQL Server Configuration Manager](../../relational-databases/sql-server-configuration-manager.md)을 참조하세요.|시작 메뉴|  
...
## <a name="tools-for-report-content-management"></a>보고서 내용 관리를 위한 도구  
 에서 콘텐츠를 관리 하는 데 사용할 수 있는 그래픽 및 스크립팅 도구 집합입니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] . 사용하는 도구는 사용하는 보고서 서버의 배포 모드에 따라 다릅니다.  
