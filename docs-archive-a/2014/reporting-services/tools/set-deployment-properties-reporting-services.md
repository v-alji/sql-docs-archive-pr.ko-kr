...
7.  **TargetServerVersion** 목록에서 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 또는 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 버전의를 선택 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 하거나 **버전 검색** 을 선택 하 여 **TargetServer URL** 속성으로 식별 되는 서버에 설치 된 버전을 자동으로 확인 합니다. 기본값은 **SQL Server 2008 R2**입니다.  
...
3.  **구성 관리자** 대화 상자에서 편집할 구성을 선택합니다. 현재 활성 구성이 **활성 ( ***\<configuration>*** )** 으로 표시 됩니다.  
