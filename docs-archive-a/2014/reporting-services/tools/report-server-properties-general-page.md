...
# <a name="server-properties-general-page"></a>서버 속성(일반 페이지)
 ...
 이 페이지를 열려면를 시작 하 고 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 보고서 서버 인스턴스에 연결한 다음 보고서 서버 이름을 마우스 오른쪽 단추로 클릭 하 고 **속성**을 선택 합니다.  
 ...
 **Version**  
 이 속성은 읽기 전용입니다. 사용 중인의 버전을 지정 합니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] .  
