...
-   값을 설정 하면 보고서 서버 구성 파일의 SecureConnectionLevel 요소가 변경 되 고 `URLRoot` 구성 파일의 요소는 지정 된 *수준이* 1 보다 크거나 같은 경우 "https://"를 사용 하도록 설정 되 고, 지정 된 *수준이* 0 인 경우에는 "http://"로 설정 됩니다.  
