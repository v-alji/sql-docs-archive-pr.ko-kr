...
4.  에서 `Hidden` 다음 옵션 중 하나를 선택 하 여 보고서를 처음 실행할 때이 보고서 항목의 표시 유형을 설정 합니다.  
    ...
    -   `False`보고서 항목을 표시 하려면 선택 합니다.  
  
    -   `True`보고서 항목을 숨기려면 선택 합니다.  
  
    -   **\<Expression>** **식** 대화 상자를 열어 표시 유형을 결정 하기 위해 런타임에 계산 되는 식을 만들려면 선택 합니다.  
...
1.  보고서 디자인 뷰에서 표시 하거나 숨길 보고서 항목을 마우스 오른쪽 단추로 클릭 한 다음 *\<report item>* **속성**을 클릭 합니다. *\<report item>* 보고서 항목에 대 한 **속성** 대화 상자가 열립니다.  
