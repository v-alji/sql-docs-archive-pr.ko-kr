...
|컨텍스트|RunningValue|RowNumber|First<br /><br /> 마지막|이전|Sum 및 기타 미리 정렬 함수|ReportItem 집계|조회 함수|Aggregate 함수|  
|-------------|------------------|---------------|--------------------|--------------|-------------------------------------|---------------------------|----------------------|------------------------|  
|Running Value|아니요|아니요|예|예|예|예|yes|예|  
|First<br /><br /> 마지막|아니요|아니요|예|예|예|예|아니요|예|  
|이전|예|예|yes|아니요|yes|예|yes|예|  
