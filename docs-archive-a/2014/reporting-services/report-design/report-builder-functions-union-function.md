...
## <a name="return"></a>반환 값  
 식 유형에 따라 `SqlGeometry` 또는 `SqlGeography` 공간 개체를 반환합니다. 및 공간 데이터 형식에 대 한 자세한 내용은 `SqlGeometry` `SqlGeography` [공간 데이터 형식 개요](../../relational-databases/spatial/spatial-data-types-overview.md)를 참조 하세요.  
