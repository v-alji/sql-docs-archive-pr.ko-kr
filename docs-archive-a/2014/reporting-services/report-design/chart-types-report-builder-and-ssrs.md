...
## <a name="choosing-a-chart-type"></a>차트 종류 선택  
 ...
 이 중 대부분의 차트 종류에 대한 예는 예제 보고서로 제공됩니다. 예제 보고서를 다운로드 하는 방법에 대 한 자세한 내용은 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [보고서 작성기 및 보고서 디자이너 샘플 보고서](https://go.microsoft.com/fwlink/?LinkId=198283)를 참조 하세요.  
