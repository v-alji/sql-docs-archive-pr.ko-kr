...
-   입력란에서 식을 사용하여 문자열의 일부를 추출합니다. 다음은 그 예입니다.  
 ...
 문자열을 데이터 형식으로 변환 하는 방법에 대 한 자세한 내용은 `DateTime` MSDN의 [날짜 및 시간 문자열 구문 분석](https://go.microsoft.com/fwlink/?LinkId=89703), [특정 문화권의 날짜 및 시간 형식 지정](https://go.microsoft.com/fwlink/?LinkId=89704)및 [DateTime, DateTimeOffset 및 TimeZoneInfo 중에서 선택](https://go.microsoft.com/fwlink/?linkid=110652) 을 참조 하세요.  
