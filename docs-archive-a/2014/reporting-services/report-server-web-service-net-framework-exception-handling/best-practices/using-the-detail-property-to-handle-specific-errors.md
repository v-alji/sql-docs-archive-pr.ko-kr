 ...
 **Detail** 속성에 포함된 사용 가능한 모든 자식 요소 목록은 [Detail 속성](../soapexception-class/detail-property.md)을 참조하세요. 자세한 내용은 SDK 설명서의 "Detail 속성"을 참조 하십시오 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] .  
