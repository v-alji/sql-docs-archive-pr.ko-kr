...
|Power View 시트가 있는 Excel 2013 통합 문서|**SharePoint 서버:** [!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] Excel 서비스에서.<br /><br /> **SharePoint Online (Office 365):** [!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] Excel Web App의|[Excel Services 또는 SharePoint Online의 Excel Web App의 파워 뷰을](#bkmk_powerview_on_ExcelServices)참조 하세요.|  
...
- SharePoint 2013 브라우저 지원에 대 한 자세한 내용은 [sharepoint 2013에서 브라우저 지원 계획](https://technet.microsoft.com//library/cc263526\(office.15\).aspx) (을 참조 하세요 https://technet.microsoft.com/library/cc263526(office.15).aspx) .  
  
- SharePoint 2010 브라우저 지원에 대 한 자세한 내용은 [브라우저 지원 계획 (SharePoint Server 2010) ()](https://technet.microsoft.com/library/cc263526\(office.14\).aspx) 을 참조 하세요 https://technet.microsoft.com/library/cc263526(office.14).aspx) .  
...
|-----------------|---------------------------|-------------------|-----------------------------------------|--------------------------------|-----------------------------|------------------------------|  
|**Internet Explorer 11(데스크톱용)**|32비트, 64비트|32비트, 64비트|32비트, 64비트|32비트, 64비트|지원 안 함|지원 안 함|  
|**Internet Explorer 10(데스크톱용)**|32비트, 64비트|32비트, 64비트|32비트, 64비트|32비트, 64비트|지원 안 함|지원 안 함|  
|**Internet Explorer 9**|지원 안 함|32비트, 64비트|지원 안 함|32비트, 64비트|32비트, 64비트|지원 안 함|  
|**Internet Explorer 8**|지원 안 함|32비트, 64비트|지원 안 함|32비트, 64비트|32비트, 64비트|지원 안 함|  
|**Mozilla Firefox (공개적으로 릴리스된 최신 버전)**|32비트|32비트|32비트|32비트|32비트|지원 안 함|  
|**Apple Safari (최신 공개 릴리스 버전)**|지원 안 함|지원 안 함|지원 안 함|지원 안 함|지원 안 함|32비트, 64비트|  
...
|**Apple Safari (최신 공개 릴리스 버전)**|지원 안 함|지원 안 함|지원 안 함|지원 안 함|지원 안 함|32비트, 64비트|  
|**Google Chrome (공개적으로 릴리스된 최신 버전)**|제한 된 시간 동안 32 비트 **( \* )**|제한 된 시간 동안 32 비트 **( \* )**|제한 된 시간 동안 32 비트 **( \* )**|제한 된 시간 동안 32 비트 **( \* )**|제한 된 시간 동안 32 비트 **( \* )**|지원 안 함|  
...
|-----------------|---------------------------|-------------------|-----------------------------------------|--------------------------------|-----------------------------|------------------------------|----------------------------|  
|**Internet Explorer 11(데스크톱용)**|32비트, 64비트|32비트, 64비트|32비트, 64비트|지원 안 함|지원 안 함|지원 안 함|지원 안 함|  
|**Internet Explorer 10(데스크톱용)**|32비트, 64비트|32비트, 64비트|32비트, 64비트|지원 안 함|지원 안 함|지원 안 함|지원 안 함|  
|**Internet Explorer 9**|지원 안 함|32비트, 64비트|지원 안 함|32비트, 64비트|32비트, 64비트|지원 안 함|지원 안 함|  
|**Internet Explorer 8**|지원 안 함|32비트, 64비트|지원 안 함|32비트, 64비트|32비트, 64비트|지원 안 함|지원 안 함|  
|**Internet Explorer 7**|지원 안 함|지원 안 함|지원 안 함|지원 안 함|32비트, 64비트|지원 안 함|지원 안 함|  
|**Mozilla Firefox (공개적으로 릴리스된 최신 버전)**|32비트|32비트|32비트|32비트|32비트|지원 안 함|지원 안 함|  
|**Apple Safari (최신 공개 릴리스 버전)**|지원 안 함|지원 안 함|지원 안 함|지원 안 함|지원 안 함|32비트, 64비트|제한 된 기능으로 지원 됨 <sup>(1)</sup>|  
|**Google Chrome (공개적으로 릴리스된 최신 버전)**|32비트|32비트|32비트|32비트|32비트|지원 안 함|지원 안 함|  
 ...
 **참고** Macintosh 컴퓨터에서 보고서 서버에 액세스하는 경우 Safari를 사용하는 것이 좋습니다. 와 통합 된 SharePoint 제품을 사용 하는 경우 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] [브라우저 지원 계획 (Windows SharePoint Services)](https://go.microsoft.com/fwlink/?LinkId=183583)을 참조 하세요.  
...
|**Internet Explorer 11 (데스크톱용)**|예|예|예|지원 안 함|지원 안 함|지원 안 함|Internet Explorer는 ReportViewer의 모든 기능을 지원합니다.|  
|**Internet Explorer 10(데스크톱용)**|예|예|예|지원 안 함|지원 안 함|지원 안 함|Internet Explorer는 ReportViewer의 모든 기능을 지원합니다.|  
|**Internet Explorer 9**|지원되지 않음|예|지원되지 않음|예|예|예|Internet Explorer는 ReportViewer의 모든 기능을 지원합니다.|  
|**Internet Explorer 8.0**|지원되지 않음|예|지원되지 않음|예|예<sup>1</sup>|지원 안 함|Internet Explorer는 ReportViewer의 모든 기능을 지원합니다. <sup>1</sup>|  
|**Internet Explorer 7.0**|지원되지 않음|예|지원되지 않음|예|예<sup>1</sup>|지원 안 함|Internet Explorer는 ReportViewer의 모든 기능을 지원합니다. <sup>1</sup>|  
|**Firefox (공개적으로 릴리스된 최신 버전)**|예|예|예|예|예|지원 안 함|인쇄 및 확대/축소는 지원되지 않습니다.|  
|**Safari (최신 공개 릴리스 버전)**|지원 안 함|지원 안 함|지원 안 함|지원 안 함|지원되지 않음|예|인쇄 및 확대/축소는 지원되지 않습니다.<br /><br /> 매개 변수가 있는 보고서에서 날짜를 선택하는 데 사용되는 달력 컨트롤은 이 브라우저에서 사용되지 않습니다. 사용자는 사용하려는 날짜를 수동으로 매개 변수 프롬프트 영역에 입력해야 합니다.|  
|**Chrome (공개적으로 릴리스된 최신 버전)**|예|예|예|예|예|지원 안 함|인쇄 및 확대/축소는 지원되지 않습니다.|  
  
 <sup>1</sup> 표준 모드에서 Internet Explorer 7.0 및 8.0은 보고서에 기울어진 선을 표시 하지 않습니다. 보고서에서 사선을 사용하는 경우 ASP.NET 페이지가 Internet Explorer의 쿼크 모드에서 실행되도록 설정하세요. 이렇게 하려면 \<!DOCTYPE> ASP.NET 페이지에서 태그를 찾습니다. 또는 마스터 페이지를 사용하는 경우 .master 파일에서 태그를 찾을 수 있습니다. 이 태그는 다음과 같습니다.  
  
```
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">  
```
  
 태그를 \<!DOCTYPE> 다음 태그로 바꿉니다.  
  
```
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">  
```
  
 Internet Explorer의 호환성 모드에 대 한 자세한 내용은 [문서 호환성 정의](https://go.microsoft.com/fwlink/?LinkId=180380) (를 참조 https://go.microsoft.com/fwlink/?LinkId=180380) 하세요.  
  
 ReportViewer 컨트롤 사용에 대 한 자세한 내용은 [보고서 및 Reportviewer 컨트롤 배포](https://msdn.microsoft.com/library/ms251723.aspx) ()를 참조 하세요 https://msdn.microsoft.com/library/ms251723.aspx) .  
