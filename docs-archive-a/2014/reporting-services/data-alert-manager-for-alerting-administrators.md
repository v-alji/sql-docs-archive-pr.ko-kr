...
|경고 이름|보고서 이름|작성자|보낸 경고|마지막 실행|마지막으로 수정한 날짜|상태|
|----------------|-----------------|----------------|-----------------|--------------|-------------------|------------|
...
|InventoryCount|StockStatusByQTR|Lauren Johnson|7|7/10/2011|7/2/2011|\<error message>로그 파일에는 오류에 대 한 자세한 정보가 포함 되어 있습니다. 식별자가 인 로그 항목을 참조 하십시오 \<GUID> .|
