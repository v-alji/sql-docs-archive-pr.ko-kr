...
### <a name="bookmarks"></a>책갈피  
 책갈피 링크는 렌더링되어 하이퍼링크로 표시됩니다. 책갈피 대상이 렌더링되고 책갈피 링크를 클릭하여 탐색할 수 있습니다. 책갈피 링크를 클릭하면 제일 앞에 있는 대상 책갈피 레이블로 보고서가 이동하며 가능한 경우 해당 책갈피 링크가 창의 맨 위에 오도록 브라우저가 스크롤됩니다. HTML 앵커 ( \<a> ) 태그는 책갈피 대상을 표시 하는 데 사용 됩니다.  
...
### <a name="hyperlinks-and-drillthrough"></a>하이퍼링크 및 드릴스루  
 하이퍼링크 및 드릴스루 링크는 정의 된 항목 주위에 HTML 앵커 () 태그를 사용 하 여 보고서 항목에 대 한 하이퍼링크로 렌더링 됩니다 \<a> .  
