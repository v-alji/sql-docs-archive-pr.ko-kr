...
## <a name="options"></a>옵션  
 **Server**  
 보고서 서버의 이름을 표시합니다. 예들 들어 `http://localhost/reportserver`입니다. 기본 포트 80 이외의 다른 포트를 사용하는 보고서 서버의 경우 포트 번호를 포함해야 합니다. 예들 들어 `http://localhost:8080/reportserver`입니다.  
