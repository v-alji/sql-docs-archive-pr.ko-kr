...
-   RSReportDesigner.config 파일의 **Designer** 요소 아래에 다음 항목을 추가 하 여 특성을 `Name` 이전 항목에서 제공한 이름으로 바꿉니다.  
