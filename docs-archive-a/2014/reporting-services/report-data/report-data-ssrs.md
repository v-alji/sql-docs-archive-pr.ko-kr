...
##  <a name="terms"></a><a name="BkMk_ReportDataTerms"></a> 용어
 ...
 개념에 익숙하지 않은 경우 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] [&#40;SSRS&#41;](../reporting-services-concepts-ssrs.md): *데이터 연결*, *포함 된 데이터 원본*, *공유 데이터 원본*, *포함 된 데이터 집합*, *공유 데이터*집합, 데이터 *집합 쿼리*, *보고서 파트*및 *데이터 경고*와 같은 Reporting Services 개념을 검토 합니다.  
