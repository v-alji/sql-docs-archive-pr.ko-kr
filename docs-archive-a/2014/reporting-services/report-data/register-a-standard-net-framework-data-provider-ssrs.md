...
1.  보고서 서버에서 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 데이터 공급자를 사용할 bin 디렉터리의 기본 위치로 이동합니다. 보고서 서버 bin 디렉터리의 기본 위치는 *\<drive>* : \Files\Microsoft SQL Server \ MSRS10_50. MSSQLSERVER\Reporting services\reportserver\bin입니다.  
...
2.  rssrvpolicy.config를 엽니다. [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)]또는 메모장과 같은 간단한 텍스트 편집기를 사용 하 여 구성 파일을 열 수 있습니다.  
...
1.  보고서 디자이너 클라이언트에서 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 데이터 공급자를 사용할 PrivateAssemblies 디렉터리의 기본 위치로 이동합니다. PrivateAssemblies 디렉터리의 기본 위치는 *\<drive>* : \Files\Microsoft Visual Studio 9.0 \ common7\ide\privateassemblies입니다.  
