...
3.  데이터베이스를 마우스 오른쪽 단추로 클릭하고 **태스크**를 선택한 다음 **미러**를 클릭합니다. 그러면 **데이터베이스 속성** 대화 상자의 [미러링 페이지가](../../relational-databases/databases/database-properties-mirroring-page.md) 열립니다.  
