...
ms.locfileid: "87741916"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="117bf-102">BLOB 출력 매개 변수에 대한 스트리밍 지원</span><span class="sxs-lookup"><span data-stu-id="117bf-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="117bf-103">이 항목에서는 BLOB 출력 매개 변수를 ISequentialStreams로 바인딩하는 BLOB 출력 매개 변수에 대한 스트리밍 지원을 보여 주는 예제를 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="117bf-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="117bf-104">IMultipleResults::GetResult 실행 중 출력 매개 변수에서 차단되어 DB_E_OBJECTOPEN 반환 값을 받을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="117bf-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="117bf-105">호출자는 보류 중인 blob 매개 변수가 있는지 확인한 후 매개 변수를 완전히 읽거나 해제해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="117bf-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="117bf-106">예제</span><span class="sxs-lookup"><span data-stu-id="117bf-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="117bf-107">코드</span><span class="sxs-lookup"><span data-stu-id="117bf-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="117bf-108">참고 항목</span><span class="sxs-lookup"><span data-stu-id="117bf-108">See Also</span></span>  
 [<span data-ttu-id="117bf-109">BLOB 및 OLE 개체</span><span class="sxs-lookup"><span data-stu-id="117bf-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
