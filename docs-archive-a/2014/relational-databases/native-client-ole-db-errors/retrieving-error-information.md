...
ms.locfileid: "87653839"
---
# <a name="retrieving-error-information"></a><span data-ttu-id="a2d4a-102">오류 정보 검색</span><span class="sxs-lookup"><span data-stu-id="a2d4a-102">Retrieving Error Information</span></span>
  <span data-ttu-id="a2d4a-103">이 예제에서는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 공급자가 제공 하는 다양 한 오류 인터페이스에서 정보를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="a2d4a-103">This example obtains information from the various error interfaces exposed by the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="a2d4a-104">참고 항목</span><span class="sxs-lookup"><span data-stu-id="a2d4a-104">See Also</span></span>  
 [<span data-ttu-id="a2d4a-105">Errors</span><span class="sxs-lookup"><span data-stu-id="a2d4a-105">Errors</span></span>](errors.md)  
