...
|연결<br /><br /> 속성(property)|Default<br /><br /> (있는 경우)|설명|  
|-----------------------------|----------------------------|-----------------|  
...
|명령<br /><br /> 속성(property)|Default<br /><br /> (있는 경우)|설명|  
|--------------------------|----------------------------|-----------------|  
...
|ClientSideXML|거짓|행 집합을 XML로 변환하는 프로세스가 서버 대신 클라이언트에서 수행되도록 하려면 이 속성을 True로 설정합니다. 이 속성은 성능 부하를 중간 계층으로 이동하려는 경우에 유용합니다.<br /><br /> 이 속성을 사용 하는 예는 [sql 쿼리 실행 &#40;SQLXMLOLEDB provider&#41;](executing-sql-queries-sqlxmloledb-provider.md) 또는 [Sql 쿼리가 포함 된 템플릿 실행 &#40;SQLXMLOLEDB provider&#41;](executing-templates-that-contain-sql-queries-sqlxmloledb-provider.md)를 참조 하세요.|  
