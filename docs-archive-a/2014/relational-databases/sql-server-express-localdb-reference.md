...
ms.locfileid: "87652048"
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="bb407-102">SQL Server Express LocalDB 참조</span><span class="sxs-lookup"><span data-stu-id="bb407-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="bb407-103">이 섹션에서는 SQL Server Express LocalDB에 대해 설명합니다.</span><span class="sxs-lookup"><span data-stu-id="bb407-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="bb407-104">SQL Server Express LocalDB 오류 메시지 참조</span><span class="sxs-lookup"><span data-stu-id="bb407-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="bb407-105">SQL Server Express LocalDB 인스턴스 API 참조</span><span class="sxs-lookup"><span data-stu-id="bb407-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="bb407-106">코드 예제</span><span class="sxs-lookup"><span data-stu-id="bb407-106">Code Sample</span></span>  
 <span data-ttu-id="bb407-107">다음 예제에서는 LocalDB API를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="bb407-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="bb407-108">이 예제를 실행하기 전에 컴퓨터에 LocalDB가 설치되어 있는지 확인하십시오.</span><span class="sxs-lookup"><span data-stu-id="bb407-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="bb407-109">[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express의 설치 프로그램에서 LocalDB를 설치할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="bb407-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
