...
ms.locfileid: "87646443"
---
# <a name="sql-server-management-objects-support-for-in-memory-oltp"></a><span data-ttu-id="2a0b2-102">메모리 내 OLTP에 대한 SQL Server 관리 개체 지원</span><span class="sxs-lookup"><span data-stu-id="2a0b2-102">SQL Server Management Objects Support for In-Memory OLTP</span></span>
  <span data-ttu-id="2a0b2-103">이 항목에서는 메모리 내 OLTP에 대한 SMO( [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 관리 개체)의 변경 내용을 설명합니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-103">This topic describes changes in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Management Objects (SMO) for In-Memory OLTP.</span></span>  
  
 <span data-ttu-id="2a0b2-104">메모리 내 OLTP를 지원하는 형식과 멤버는 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-104">The following types and members support In-Memory OLTP:</span></span>  
...
## <a name="code-sample"></a><span data-ttu-id="2a0b2-105">코드 예제</span><span class="sxs-lookup"><span data-stu-id="2a0b2-105">Code Sample</span></span>  
 <span data-ttu-id="2a0b2-106">이 샘플 애플리케이션은 다음을 수행합니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-106">This sample does the following:</span></span>  
  
-   <span data-ttu-id="2a0b2-107">메모리 최적화 파일 그룹 및 메모리 최적화 파일이 있는 데이터베이스를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-107">Creates a database with memory-optimized filegroup and memory-optimized file.</span></span>  
  
-   <span data-ttu-id="2a0b2-108">기본 키, 비클러스터형 인덱스 및 비클러스터형 해시 인덱스가 있는 영구 메모리 최적화 테이블을 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-108">Creates a durable memory-optimized table with a primary key, nonclustered index, and a nonclustered hash index.</span></span>  
  
-   <span data-ttu-id="2a0b2-109">열 및 인덱스를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-109">Creates columns and indexes.</span></span>  
  
-   <span data-ttu-id="2a0b2-110">사용자 정의 메모리 최적화 테이블 형식을 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-110">Creates a user-defined memory-optimized table type.</span></span>  
  
-   <span data-ttu-id="2a0b2-111">고유하게 컴파일된 저장 프로시저를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-111">Creates a natively compiled stored procedure.</span></span>  
  
 <span data-ttu-id="2a0b2-112">이 예제는 다음 어셈블리를 참조해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a0b2-112">This sample needs to reference the following assemblies:</span></span>  
  
-   <span data-ttu-id="2a0b2-113">Microsoft.SqlServer.Smo.dll</span><span class="sxs-lookup"><span data-stu-id="2a0b2-113">Microsoft.SqlServer.Smo.dll</span></span>  
  
-   <span data-ttu-id="2a0b2-114">Microsoft.SqlServer.Management.Sdk.Sfc.dll</span><span class="sxs-lookup"><span data-stu-id="2a0b2-114">Microsoft.SqlServer.Management.Sdk.Sfc.dll</span></span>  
  
-   <span data-ttu-id="2a0b2-115">Microsoft.SqlServer.ConnectionInfo.dll</span><span class="sxs-lookup"><span data-stu-id="2a0b2-115">Microsoft.SqlServer.ConnectionInfo.dll</span></span>  
  
-   <span data-ttu-id="2a0b2-116">Microsoft.SqlServer.SqlEnum.dll</span><span class="sxs-lookup"><span data-stu-id="2a0b2-116">Microsoft.SqlServer.SqlEnum.dll</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="2a0b2-117">참고 항목</span><span class="sxs-lookup"><span data-stu-id="2a0b2-117">See Also</span></span>  
 [<span data-ttu-id="2a0b2-118">메모리 내 OLTP에 대한 SQL Server 지원</span><span class="sxs-lookup"><span data-stu-id="2a0b2-118">SQL Server Support for In-Memory OLTP</span></span>](sql-server-support-for-in-memory-oltp.md)  
