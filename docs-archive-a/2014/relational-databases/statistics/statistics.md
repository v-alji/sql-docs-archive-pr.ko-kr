...
##  <a name="when-to-create-statistics"></a><a name="CreateStatistics"></a>통계를 만들어야 하는 경우  
...
##  <a name="when-to-update-statistics"></a><a name="UpdateStatistics"></a>통계를 업데이트 하는 경우  
...
##  <a name="queries-that-use-statistics-effectively"></a><a name="DesignStatistics"></a>통계를 효과적으로 사용 하는 쿼리  
