...
1.  <span data-ttu-id="607ba-111">환경 핸들 및 연결 핸들을 할당합니다.</span><span class="sxs-lookup"><span data-stu-id="607ba-111">Allocate an environment handle and a connection handle.</span></span>  
