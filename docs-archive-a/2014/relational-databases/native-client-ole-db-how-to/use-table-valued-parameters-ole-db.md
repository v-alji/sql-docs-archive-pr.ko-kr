...
ms.locfileid: "87739844"
---
# <a name="use-table-valued-parameters-ole-db"></a><span data-ttu-id="cd98c-102">테이블 반환 매개 변수 사용(OLE DB)</span><span class="sxs-lookup"><span data-stu-id="cd98c-102">Use Table-Valued Parameters (OLE DB)</span></span>
  <span data-ttu-id="cd98c-103">이 예제는 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상에서만 작동합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-103">This sample works with [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] or later.</span></span> <span data-ttu-id="cd98c-104">이 샘플 애플리케이션은 다음을 수행합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-104">This sample does the following:</span></span>  
  
-   <span data-ttu-id="cd98c-105">IOpenRowset::OpenRowset을 통해 동적 검색을 사용하여 테이블 반환 매개 변수를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-105">Creates table-valued parameters by using dynamic discovery though IOpenRowset::OpenRowset.</span></span>  
  
-   <span data-ttu-id="cd98c-106">EmployeesRowset 클래스의 끌어오기 모델을 사용하여 테이블 반환 매개 변수 행을 보냅니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-106">Sends table-valued parameter rows by using the pull model in the EmployeesRowset class.</span></span> <span data-ttu-id="cd98c-107">끌어오기 모델에서는 소비자가 공급자에게 데이터를 요청 시 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-107">In the pull model, the consumer provides data on demand to the provider.</span></span>  
  
-   <span data-ttu-id="cd98c-108">CPhotograph 클래스에 있는 테이블 반환 매개 변수의 일부로 BLOB을 보냅니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-108">Sends BLOBs as part of a table-valued parameter in the CPhotograph class.</span></span>  
  
-   <span data-ttu-id="cd98c-109">ISSCommandWithParameters를 사용하는 사용자 지정 매개 변수 속성을 사용합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-109">Uses custom parameter properties using ISSCommandWithParameters.</span></span>  
  
-   <span data-ttu-id="cd98c-110">SQLNCLI11 오류를 처리하는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-110">Shows error handling for SQLNCLI11 errors.</span></span>  
  
 <span data-ttu-id="cd98c-111">테이블 반환 매개 변수에 대 한 자세한 내용은 [테이블 반환 매개 변수 &#40;SQL Server Native Client&#41;](../native-client/features/table-valued-parameters-sql-server-native-client.md)를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="cd98c-111">For more information about table-valued parameters, see [Table-Valued Parameters &#40;SQL Server Native Client&#41;](../native-client/features/table-valued-parameters-sql-server-native-client.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="cd98c-112">예제</span><span class="sxs-lookup"><span data-stu-id="cd98c-112">Example</span></span>  
 <span data-ttu-id="cd98c-113">첫 번째([!INCLUDE[tsql](../../includes/tsql-md.md)]) 코드 목록은 예제에서 사용하는 데이터베이스를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-113">The first ([!INCLUDE[tsql](../../includes/tsql-md.md)]) code listing creates the database used by the sample.</span></span>  
  
 <span data-ttu-id="cd98c-114">두 번째 코드 목록을 stdafx.h라는 파일에 배치합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-114">Put the second code listing into a file called stdafx.h.</span></span>  
  
 <span data-ttu-id="cd98c-115">세 번째 코드 목록을 OLEDBUtils.hpp라는 파일에 배치합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-115">Put the third code listing into a file called OLEDBUtils.hpp.</span></span>  
  
 <span data-ttu-id="cd98c-116">ole32.lib oleaut32.lib를 사용하여 컴파일하고 네 번째(C++) 코드 목록을 실행합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-116">Compile with ole32.lib oleaut32.lib and execute the fourth (C++) code listing.</span></span> <span data-ttu-id="cd98c-117">이 애플리케이션은 컴퓨터의 기본 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스에 연결됩니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-117">This application connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="cd98c-118">일부 Windows 운영 체제에서는 (localhost) 또는 (local)을 해당 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스의 이름으로 변경해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-118">On some Windows operating systems, you will need to change (localhost) or (local) to the name of your [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="cd98c-119">명명된 인스턴스에 연결하려면 연결 문자열을 L"(local)"에서 L"(local)\\\name"으로 변경합니다. 여기서 name은 명명된 인스턴스입니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-119">To connect to a named instance, change the connection string from L"(local)" to L"(local)\\\name" , where name is the named instance.</span></span> <span data-ttu-id="cd98c-120">기본적으로 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express는 명명된 인스턴스에 설치됩니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-120">By default, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express installs to a named instance.</span></span> <span data-ttu-id="cd98c-121">INCLUDE 환경 변수에 sqlncli.h가 들어 있는 디렉터리를 포함해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-121">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="cd98c-122">다섯 번째([!INCLUDE[tsql](../../includes/tsql-md.md)]) 코드 목록은 예제에서 사용하는 데이터베이스를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="cd98c-122">The fifth ([!INCLUDE[tsql](../../includes/tsql-md.md)]) code listing creates the database used by the sample.</span></span>  
