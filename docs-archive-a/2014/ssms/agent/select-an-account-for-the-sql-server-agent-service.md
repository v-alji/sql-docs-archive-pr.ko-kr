...
|네트워크 서비스 계정(NT AUTHORITY\NetworkService)|지원 되<sup>는 1, 3, 4</sup>|지원 안 함|지원 안 함|  
|로컬 사용자 계정(비관리자)|지원 됨<sup>1</sup>|지원 안 함|해당 없음|  
|로컬 시스템 계정(NT AUTHORITY\System)|지원 됨<sup>2</sup>|지원 안 함|지원 됨<sup>2</sup>|  
|로컬 서비스 계정(NT AUTHORITY\LocalService)|지원되지 않음|지원 안 함|지원 안 함|  
