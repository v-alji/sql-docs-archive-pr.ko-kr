...
## <a name="changing-to-the-vs_dev10_long-keyboard-scheme"></a>[!INCLUDE[vs_dev10_long](../../includes/vs-dev10-long-md.md)] 키보드 구성표로 변경  
  
#### <a name="to-apply-vs_dev10_long-compatible-keyboard-scheme"></a>[!INCLUDE[vs_dev10_long](../../includes/vs-dev10-long-md.md)] 호환 키보드 구성표를 적용하려면  
